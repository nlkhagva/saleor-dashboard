...
export interface ProductVariantReorder_productVariantReorder_product_category_parent_parent_parent {
  __typename: "Category";
  /**
   * The ID of the object.
   */
...
export interface ProductVariantReorder_productVariantReorder_product_category_parent_parent {
  __typename: "Category";
  /**
   * The ID of the object.
   */
  id: string;
  name: string;
  parent: ProductVariantReorder_productVariantReorder_product_category_parent_parent_parent | null;
}

export interface ProductVariantReorder_productVariantReorder_product_category_parent {
  __typename: "Category";
  /**
   * The ID of the object.
   */
  id: string;
  name: string;
  parent: ProductVariantReorder_productVariantReorder_product_category_parent_parent | null;
}
