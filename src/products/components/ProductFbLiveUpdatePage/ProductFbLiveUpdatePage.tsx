...
export const ProductFbLiveUpdatePage: React.FC<ProductUpdatePageProps> = ({
  defaultWeightUnit,
  disabled,
...
ProductFbLiveUpdatePage.displayName = "ProductUpdatePage";
export default ProductFbLiveUpdatePage;
