...
export interface OrderMarkAsPaid_orderMarkAsPaid_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderMarkAsPaid_orderMarkAsPaid_order_fulfillments_lines_orderLine_variant_product | null;
  /**
...
export interface OrderMarkAsPaid_orderMarkAsPaid_order_lines_variant {
  __typename: "ProductVariant";
  product: OrderMarkAsPaid_orderMarkAsPaid_order_lines_variant_product | null;
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
