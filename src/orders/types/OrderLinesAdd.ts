...
import { OrderLineCreateInput, OrderErrorCode, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentLineUstatus, FulfillmentStatus, PaymentChargeStatusEnum, OrderStatus, OrderAction, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_productType {
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product {
   ...
   */
  id: string;
  productType: OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_productType;
  ushop: OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product_metadata | null)[];
}

export interface OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant {
  __typename: "ProductVariant";
  product: OrderLinesAdd_draftOrderLinesCreate_order_fulfillments_lines_orderLine_variant_product | null;
  /**
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_productType {
  __typename: "ProductType";
  /**
   * The ID of the object.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product {
   ...
   */
  id: string;
  productType: OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_productType;
  ushop: OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product_metadata | null)[];
}

export interface OrderLinesAdd_draftOrderLinesCreate_order_lines_variant {
  __typename: "ProductVariant";
  product: OrderLinesAdd_draftOrderLinesCreate_order_lines_variant_product | null;
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_payments_capturedAmount {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface OrderLinesAdd_draftOrderLinesCreate_order_payments {
  __typename: "Payment";
  /**
   * The ID of the object.
   */
   ...
   */
  capturedAmount: OrderLinesAdd_draftOrderLinesCreate_order_payments_capturedAmount | null;
}
...
export interface OrderLinesAdd_draftOrderLinesCreate_order {
   ...
   */
  payments: (OrderLinesAdd_draftOrderLinesCreate_order_payments | null)[] | null;
