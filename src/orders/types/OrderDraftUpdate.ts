...
import { DraftOrderInput, OrderErrorCode, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentLineUshopStatus, FulfillmentStatus, PaymentChargeStatusEnum, OrderStatus, OrderAction, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_productType {
...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product {
   ...
   */
  id: string;
  productType: OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_productType;
  ushop: OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderDraftUpdate_draftOrderUpdate_order_fulfillments_lines_orderLine_variant_product_metadata | null)[];
}
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_productType {
  __typename: "ProductType";
  /**
   * The ID of the object.
   */
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product {
   ...
   */
  id: string;
  productType: OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_productType;
  ushop: OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderDraftUpdate_draftOrderUpdate_order_lines_variant_product_metadata | null)[];
}
