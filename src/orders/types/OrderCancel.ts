...
export interface OrderCancel_orderCancel_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderCancel_orderCancel_order_fulfillments_lines_orderLine_variant_product | null;
  /**
...
export interface OrderCancel_orderCancel_order_lines_variant {
  __typename: "ProductVariant";
  product: OrderCancel_orderCancel_order_lines_variant_product | null;
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface OrderCancel_orderCancel_order_payments_capturedAmount {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface OrderCancel_orderCancel_order_payments {
  __typename: "Payment";
  /**
   * The ID of the object.
   */
   ...
   */
  capturedAmount: OrderCancel_orderCancel_order_payments_capturedAmount | null;
}
...
export interface OrderCancel_orderCancel_order {
   ...
   */
  payments: (OrderCancel_orderCancel_order_payments | null)[] | null;
