...
import { OrderUpdateInput, OrderErrorCode, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentLineUstatus, FulfillmentStatus, PaymentChargeStatusEnum, OrderStatus, OrderAction, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_productType {
...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product {
   ...
   */
  id: string;
  productType: OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_productType;
  ushop: OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product_metadata | null)[];
}

export interface OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant {
  __typename: "ProductVariant";
  product: OrderUpdate_orderUpdate_order_fulfillments_lines_orderLine_variant_product | null;
  /**
...
export interface OrderUpdate_orderUpdate_order_lines_variant_product_productType {
  __typename: "ProductType";
  /**
   * The ID of the object.
   */
...
export interface OrderUpdate_orderUpdate_order_lines_variant_product_ushop {
  __typename: "Ushop";
  /**
   * The ID of the object.
   */
...
export interface OrderUpdate_orderUpdate_order_lines_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface OrderUpdate_orderUpdate_order_lines_variant_product {
   ...
   */
  id: string;
  productType: OrderUpdate_orderUpdate_order_lines_variant_product_productType;
  ushop: OrderUpdate_orderUpdate_order_lines_variant_product_ushop | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (OrderUpdate_orderUpdate_order_lines_variant_product_metadata | null)[];
}

export interface OrderUpdate_orderUpdate_order_lines_variant {
  __typename: "ProductVariant";
  product: OrderUpdate_orderUpdate_order_lines_variant_product | null;
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface OrderUpdate_orderUpdate_order_payments_capturedAmount {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface OrderUpdate_orderUpdate_order_payments {
  __typename: "Payment";
  /**
   * The ID of the object.
   */
   ...
   */
  capturedAmount: OrderUpdate_orderUpdate_order_payments_capturedAmount | null;
}
...
export interface OrderUpdate_orderUpdate_order {
   ...
   */
  payments: (OrderUpdate_orderUpdate_order_payments | null)[] | null;
