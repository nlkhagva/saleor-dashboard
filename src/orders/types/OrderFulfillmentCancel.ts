...
import { FulfillmentCancelInput, OrderErrorCode, OrderEventsEmailsEnum, OrderEventsEnum, FulfillmentLineUstatus, FulfillmentStatus, PaymentChargeStatusEnum, OrderStatus, OrderAction, JobStatusEnum } from "./../../types/globalTypes";
...
export interface OrderFulfillmentCancel_orderFulfillmentCancel_order_fulfillments_lines_orderLine_variant {
  ...
  product: OrderFulfillmentCancel_orderFulfillmentCancel_order_fulfillments_lines_orderLine_variant_product | null;
  /**
...
export interface OrderFulfillmentCancel_orderFulfillmentCancel_order_lines_variant {
  __typename: "ProductVariant";
  product: OrderFulfillmentCancel_orderFulfillmentCancel_order_lines_variant_product | null;
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface OrderFulfillmentCancel_orderFulfillmentCancel_order_payments_capturedAmount {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface OrderFulfillmentCancel_orderFulfillmentCancel_order {
   ...
   */
  payments: (OrderFulfillmentCancel_orderFulfillmentCancel_order_payments | null)[] | null;
