            ...
            <TableRow hover={true} key={maybe(() => line.id)}>
              ...
              >
                <Typography variant="caption">
                  {maybe(() => line.fulfillmentline.orderLine.productName) || (
                    <Skeleton />
                  )}
                </Typography>
              ...
              <TableCell className={classes.colPrice}>
                {maybe(() => line.fulfillmentline.orderLine.unitPrice.gross) ? (
                  <Money
                  ...
                  <Money
                    money={{
                      amount:
                        ...
                        line.fulfillmentline.orderLine.unitPrice.gross.amount,
                      currency:
                        line.fulfillmentline.orderLine.unitPrice.gross.currency
                    }}
                  />
                ) : (
                  <Skeleton />
